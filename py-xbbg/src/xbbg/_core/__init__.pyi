# This file is generated by pyo3_stub_gen, with hand-maintained compatibility
# declarations for runtime exports that the generator currently misses.
...
class PyEngine:
    ...
    def market_timing(
        ...
        ticker: builtins.str,
        date: builtins.str,
        timing: builtins.str = "EOD",
        tz: typing.Optional[builtins.str] = None,
    ) -> typing.Any:
        r"""
    ...
    def resolve_field_types(
        ...
        overrides: typing.Optional[typing.Mapping[builtins.str, builtins.str]] = None,
        default_type: builtins.str = "string",
    ) -> typing.Any:
        r"""
    ...
    def subscribe(
        self,
        tickers: typing.Sequence[builtins.str],
        fields: typing.Sequence[builtins.str],
        flush_threshold: typing.Optional[builtins.int] = None,
        overflow_policy: typing.Optional[builtins.str] = None,
        stream_capacity: typing.Optional[builtins.int] = None,
        recovery_policy: typing.Optional[builtins.str] = None,
    ) -> typing.Any:
        r"""
...
class PySubscription:
    ...
    def __aexit__(
        ...
        _exc_val: typing.Optional[typing.Any] = None,
        _exc_tb: typing.Optional[typing.Any] = None,
    ) -> typing.Any:
        r"""
...
def ext_build_corporate_bonds_query(
    ticker: builtins.str,
    ccy: typing.Optional[builtins.str] = None,
    extra_fields: typing.Sequence[builtins.str] = [],
    active_only: builtins.bool = True,
) -> builtins.str:
    r"""
...
def ext_build_earning_header_rename(
    header_row: typing.Sequence[tuple[builtins.str, builtins.str]], data_columns: typing.Sequence[builtins.str]
...
def ext_build_etf_holdings_query(
    etf_ticker: builtins.str, extra_fields: typing.Sequence[builtins.str] = []
) -> builtins.str:
    r"""
...
def ext_build_futures_ticker(
    prefix: builtins.str, month_code: builtins.str, year: builtins.str, asset: builtins.str
) -> builtins.str:
    r"""
    Build a futures ticker from components.
    """

def ext_build_fx_pair(
    from_ccy: builtins.str, to_ccy: builtins.str
) -> tuple[builtins.str, builtins.float, builtins.str, builtins.str]:
    r"""
...
def ext_build_preferreds_query(
    equity_ticker: builtins.str, extra_fields: typing.Sequence[builtins.str] = []
) -> builtins.str:
    r"""
...
def ext_build_yas_overrides(
    settle_dt: typing.Optional[builtins.str] = None,
    yield_type: typing.Optional[builtins.int] = None,
    spread: typing.Optional[builtins.float] = None,
    yield_val: typing.Optional[builtins.float] = None,
    price: typing.Optional[builtins.float] = None,
    benchmark: typing.Optional[builtins.str] = None,
) -> builtins.list[tuple[builtins.str, builtins.str]]:
    r"""
...
def ext_calculate_level_percentages(
    values: typing.Sequence[typing.Optional[builtins.float]], levels: typing.Sequence[typing.Optional[builtins.int]]
) -> builtins.list[typing.Optional[builtins.float]]:
    r"""
...
def ext_currencies_needing_conversion(
    currencies: typing.Sequence[builtins.str], target: builtins.str
) -> builtins.list[builtins.str]:
    r"""
    Get currencies that need FX conversion.
    """

def ext_default_bqr_datetimes(
    start_datetime: typing.Optional[builtins.str] = None, end_datetime: typing.Optional[builtins.str] = None
...
def ext_default_turnover_dates(
    start_date: typing.Optional[builtins.str] = None, end_date: typing.Optional[builtins.str] = None
) -> tuple[builtins.str, builtins.str]:
    r"""
...
def ext_derive_sessions(
    day_start: builtins.str,
    day_end: builtins.str,
    mic: typing.Optional[builtins.str],
    exch_code: typing.Optional[builtins.str],
) -> builtins.dict[builtins.str, tuple[builtins.str, builtins.str]]:
    r"""
...
def ext_filter_candidates_by_cycle(
    candidates: typing.Sequence[tuple[builtins.str, builtins.int, builtins.int]], cycle: builtins.str
) -> builtins.list[tuple[builtins.str, builtins.int, builtins.int]]:
    r"""
...
def ext_filter_valid_contracts(
    contracts: typing.Sequence[tuple[builtins.str, builtins.str]],
    year: builtins.int,
    month: builtins.int,
    day: builtins.int,
) -> builtins.list[builtins.str]:
...
def ext_fmt_date(
    year: builtins.int, month: builtins.int, day: builtins.int, fmt: typing.Optional[builtins.str] = None
) -> builtins.str:
    r"""
    Format a date to string.
    """

def ext_generate_futures_candidates(
    gen_ticker: builtins.str,
    year: builtins.int,
    month: builtins.int,
    day: builtins.int,
    freq: builtins.str = "M",
    count: builtins.int = 4,
) -> builtins.list[tuple[builtins.str, builtins.int, builtins.int]]:
    r"""
...
def ext_get_market_rule(
    mic: typing.Optional[builtins.str], exch_code: typing.Optional[builtins.str]
...
def ext_parse_cdx_ticker(
    ticker: builtins.str,
) -> tuple[builtins.str, builtins.str, builtins.str, builtins.str, builtins.bool, typing.Optional[builtins.int]]:
    r"""
    Parse a CDX ticker.
...
def ext_parse_ticker(
    ticker: builtins.str,
) -> tuple[builtins.str, builtins.int, builtins.str, typing.Optional[builtins.str]]:
    r"""
...
def ext_rename_dividend_columns(
...
def ext_session_times_to_utc(
    start_time: builtins.str, end_time: builtins.str, exchange_tz: builtins.str, date: builtins.str
) -> tuple[builtins.str, builtins.str]:
    r"""
...
def ext_set_exchange_override(
    ...
    mic: typing.Optional[builtins.str] = None,
    exch_code: typing.Optional[builtins.str] = None,
    day: typing.Optional[tuple[builtins.str, builtins.str]] = None,
    allday: typing.Optional[tuple[builtins.str, builtins.str]] = None,
    pre: typing.Optional[tuple[builtins.str, builtins.str]] = None,
    post: typing.Optional[tuple[builtins.str, builtins.str]] = None,
    am: typing.Optional[tuple[builtins.str, builtins.str]] = None,
    pm: typing.Optional[tuple[builtins.str, builtins.str]] = None,
) -> None:
    r"""
...
def recipe_active_cdx(
    engine: PyEngine, gen_ticker: builtins.str, dt: builtins.str, lookback_days: typing.Optional[builtins.int] = None
) -> typing.Any:
    r"""
...
def recipe_active_futures(
    engine: PyEngine, gen_ticker: builtins.str, dt: builtins.str, freq: typing.Optional[builtins.str] = None
) -> typing.Any:
    r"""
...
def recipe_bqr(
    ...
    end_datetime: builtins.str,
    event_types: typing.Optional[typing.Sequence[builtins.str]] = None,
    include_broker_codes: builtins.bool = True,
) -> typing.Any:
    r"""
...
def recipe_currency_conversion(
    engine: PyEngine, ticker: builtins.str, target_ccy: builtins.str, start_date: builtins.str, end_date: builtins.str
) -> typing.Any:
    r"""
...
def recipe_dividend(
    ...
    dvd_type: typing.Optional[builtins.str] = None,
) -> typing.Any:
    r"""
...
def recipe_etf_holdings(
    engine: PyEngine, etf_ticker: builtins.str, fields: typing.Optional[typing.Sequence[builtins.str]] = None
) -> typing.Any:
    r"""
...
def recipe_preferreds(
    engine: PyEngine, ticker: builtins.str, fields: typing.Optional[typing.Sequence[builtins.str]] = None
) -> typing.Any:
    r"""
...
def enable_sdk_logging(level: builtins.str) -> None:
    r"""
    Enable Bloomberg SDK logging at the requested level.
    """

def sdk_version() -> tuple[builtins.int, builtins.int, builtins.int, builtins.int]:
    r"""
    Return the linked Bloomberg SDK version as ``(major, minor, patch, build)``.
    """
